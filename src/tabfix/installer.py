...
def main():
    ...
    SCRIPT_URL = (
        "https://raw.githubusercontent.com/hairpin01/tabfix/refs/heads/main/src/tabfix/tabfix"
    )

    existing_path, install_type = find_existing_installation()

    if existing_path:
        print_color("Found existing installation:", Colors.GREEN)
    ...
    if not script_content:
        print_color(
            "Failed to download script. Using local version if available.",
            Colors.YELLOW,
        )
